...
function Projects({show}) {
    ...
    return (
        <>
            ...
            <span className={`${show ? 'flex' : 'hidden'} flex-col items-start justify-start w-full gap-y-5 pb-3 bg-white rounded-md`} style={{height: '-webkit-fill-available'}} ref={settingsRef}>
